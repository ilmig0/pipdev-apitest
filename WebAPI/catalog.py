...
class Catalog:
    ...
    def request_fact(self, ksip_api, fact_method, date, shift):
        facts = list()
        for section in self.__sections.values():
            facts = facts + ksip_api.get_fact(fact_method, date, shift, self.__mine, section.idShaft, section.idSection)
    ...
    def __print_facts(self, facts):
        ...
        for fact in facts:
            ...
            ore_pass = Catalog.__item_attr_to_str(self.__orepass, fact.idOrePass, 'name')
    ...
    def __print_skip_orders(self, skip_orders):
        ...
        for skip_order in skip_orders:
            ...
            ore_pass = Catalog.__item_attr_to_str(self.__orepass, skip_order.idSource, 'name')
    ...
    def __print_work_orders(self, work_orders):
        ...
        fs = '{0:5s}  {1:5s}  {2:45s}  {3:30s}  {4:35s}  {5:25s}  {6:25s}  {7:40s}  {8:5s}  {9:10s}  {10:7s}  {11}\n'
        ...
        for work_order in work_orders:
            ...
            ore_pass = Catalog.__item_attr_to_str(self.__orepass, work_order.idOrePass, 'name')
